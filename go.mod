...
replace (
	sigs.k8s.io/cloud-provider-azure/pkg/azclient v0.12.0 => ./pkg/azclient
	sigs.k8s.io/cloud-provider-azure/pkg/azclient/cache v0.9.1 => ./pkg/azclient/cache
	sigs.k8s.io/cloud-provider-azure/pkg/azclient/configloader v0.10.3 => ./pkg/azclient/configloader
)
